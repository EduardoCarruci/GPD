        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                  "Más de 8 años de experiencia y desarrollo web y más de 5 años en desarrollo de aplicaciones móviles"),
            ),
            _buildTitle("Skills"),
            ...
            _buildExperienceRow(
                company: "GID Nepal",
                position: "Desarrollador de Wordpress",
                duration: "2010 - 2012"),
            _buildExperienceRow(
                company: "Lohani Tech",
      ...
      children: <Widget>[
        ...
        Container(
            ...
            child: CircleAvatar(
                ...
                child: CircleAvatar(
                    radius: 35.0,backgroundImage: AssetImage('assets/img/pp.jpg'),))),
        SizedBox(width: 20.0),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
